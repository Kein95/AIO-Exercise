# -*- coding: utf-8 -*-
"""M3_W1_Data_Analysis_B_Time_Series_data.ipynb.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/14XsByBA6swq1NUieq4JBpSLoBeaU9TtQ
"""
...
# Assuming 'opsd_daily' is a DataFrame and 'Consumption' is a column in it
# Plotting the 'Consumption' column
...
for name, ax in zip(['Consumption', 'Solar', 'Wind'], axes):
    sns.boxplot(data=opsd_daily, x='Month', y=name, ax=ax, palette="pastel")
    ax.set_ylabel('GWh')
    ax.set_title(name)
    if ax != axes[-1]:
        ax.set_xlabel('')
