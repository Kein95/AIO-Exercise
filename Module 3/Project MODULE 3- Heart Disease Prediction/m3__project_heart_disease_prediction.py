...
# Khởi tạo mô hình XGBoost với các tham số đã cho
...
# Khởi tạo các mô hình học cơ sở với tham số điều chỉnh
dtc = DecisionTreeClassifier(random_state=42, max_depth=4)
rfc = RandomForestClassifier(random_state=42, n_estimators=50, max_depth=4)
knn = KNeighborsClassifier(n_neighbors=5)
xgb = XGBClassifier(random_state=42, n_estimators=50, max_depth=3)
gc = GradientBoostingClassifier(random_state=42, n_estimators=50, max_depth=3)
svc = SVC(kernel='rbf', random_state=42, C=1.0, probability=True)
ad = AdaBoostClassifier(random_state=42, n_estimators=50)

# Khởi tạo mô hình meta learner (ở đây là Logistic Regression)
meta_learner = LogisticRegression()

# Kết hợp các mô hình cơ sở vào StackingClassifier
