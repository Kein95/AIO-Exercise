# -*- coding: utf-8 -*-
"""M5_Project_Vanishing_Gradient_5_Skip_Connection.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1Y-8QnRd-3UGPesHFmbepj9hJ9lk6a5OI
"""
...
class MLP(nn.Module):
    ...
    def forward(self, x):
        ...
        x = self.layer1(x)
        x = nn.Sigmoid()(x)
        skip = x  # Lưu skip connection từ layer1
        ...
        x = self.layer3(x)
        x = nn.Sigmoid()(x)
        x = skip + x  # Thêm skip connection từ layer1

        # Block 3
        x = self.layer4(x)
        x = nn.Sigmoid()(x)
        skip = x  # Lưu skip connection từ layer4
        ...
        x = self.layer7(x)
        x = nn.Sigmoid()(x)
        x = skip + x  # Thêm skip connection từ layer4
