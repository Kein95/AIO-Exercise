# -*- coding: utf-8 -*-
"""M5_Project_Vanishing_Gradient_1b_Weight_Increasing.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1X35jte8XdRbpp30InK4IL7MLIWQ8BJjt
"""
...
class MLP(nn.Module):
    def __init__(self, input_dims, hidden_dims, output_dims):
        ...
        # Khởi tạo trọng số với phân phối chuẩn (std lớn hơn)
        for module in self.modules():
            if isinstance(module, nn.Linear):
                nn.init.normal_(module.weight, mean=0.0, std=10.0)  # std=10.0 hoặc lớn hơn
